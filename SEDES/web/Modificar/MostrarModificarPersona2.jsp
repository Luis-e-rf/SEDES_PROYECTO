...
%> 
    ...
    Listar = tipodoc.ListarTipoDocumentoUnico(id_tipo_documento);

    for (Object Listar21 : Listar) {
    ...
    Listar = tipPer.ListarTipoPersonaunico(id_Tipo_Persona);

    for (Object Listar31 : Listar) {
        TipoPers = (TipoPersona) Listar31;
        nombre_tipo_documento = TipoPers.getNombre_Tipo_Persona();
    }
    ...
    Listar = fich.ListarFichaUnico(numero_ficha);

    for (Object Listar3 : Listar) {
        Fic = (Ficha) Listar3;
...
<html>
    ...
    <center><img src="../imagenes/modificar.png" alt=""/></center>
       ...
       <form id="form6" name="form6" method="post" action="../ProcesarModificar/ProcesarModificarPersona2.jsp">
    ...
    <tr>
      ...
      Listar=TipoDocumento.ListarTipoDocumento();
        ...
        out.print("<option selected value=" + id_tipo_documento + ">" + nombre_tipo_documento + "</option>");
        %>
        </select>
      </label></td>
    </tr>
